...
public typealias CarTrack_UserDetailsNetWorkRepositoryCompletionHandler = (_ result: Result<NetworkClientResponse<[CarTrack.CarTrackUserResponseDtoElement]>>) -> Void
