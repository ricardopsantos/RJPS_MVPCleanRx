...
extension RJSLib {
    ...
    public struct Logger {
        ...
        public static func message(_ message: Any?, function: String = #function, file: String = #file, line: Int = #line) {
        ...
        public static func error(_ message: Any?, shouldCrash: Bool=false, function: String = #function, file: String = #file, line: Int = #line) {
            guard message != nil else { return }
