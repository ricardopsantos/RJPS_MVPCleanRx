...
extension RJSLib {
    ...
    public class CoreDataManager {
        ...
        static var managedObjectModel: NSManagedObjectModel = {
            ...
            let frameworkBundleIdentifier = "RJPS.RJPSLib.Storage"
            if let customKitBundle = Bundle(identifier: frameworkBundleIdentifier) {
            ...
            //    return NSManagedObjectModel(contentsOf: modelURL)!
            //}
            RJS_Utils.assert(false, message: "Fail getting CoreData DB [\(dbName)]")
        ...
        static var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
            ...
            do {
                ...
                RJS_Logs.error("Unresolved error \(wrappedError), \(wrappedError.userInfo)")
                abort()
            }
            return coordinator
        }()
