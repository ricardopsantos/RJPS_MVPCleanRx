...
public protocol BlissQuestionsAPIUseCaseProtocol: class {
    ...
    func getQuestions(limit: Int,
                      filter: String,
                      offSet: Int,
                      checkHealth: Bool,
                      completionHandler: @escaping (Result<[Bliss.QuestionElementResponseDto]>) -> Void)

    func getQuestionBy(id: Int,
                       checkHealth: Bool,
                       completionHandler: @escaping (_ result: Result<Bliss.QuestionElementResponseDto>) -> Void)
    ...
    func shareQuestionBy(email: String,
                         url: String,
                         checkHealth: Bool,
                         completionHandler: @escaping (_ result: Result<Bliss.ShareByEmail>) -> Void)
