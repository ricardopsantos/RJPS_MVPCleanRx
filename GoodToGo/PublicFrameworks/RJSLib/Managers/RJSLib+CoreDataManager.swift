...
extension RJSLib {
    ...
    class CoreDataManager {
        ...
        static func dbName() -> String { return "GoodToGo" }
        ...
        static var managedObjectModel: NSManagedObjectModel = {
            ...
            RJSLib.Utils.ASSERT_TRUE(false, message: "Fail getting CoreData DB [\(dbName())]")
            return NSManagedObjectModel()
        }()
        
        func managedObjectModel(ressourceName:String) -> NSManagedObjectModel {
            // The managed object model for the application. This property is not optional. It is a fatal error for the application not to be able to find and load its model.
            let modelURL = Bundle.main.url(forResource: ressourceName, withExtension: "momd")!
            return NSManagedObjectModel(contentsOf: modelURL)!
        }
        ...
        static var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
            ...
            do {
                ...
                RJSLib.Logs.DLogError("Unresolved error \(wrappedError), \(wrappedError.userInfo)")
                abort()
            }
            return coordinator
        }()
