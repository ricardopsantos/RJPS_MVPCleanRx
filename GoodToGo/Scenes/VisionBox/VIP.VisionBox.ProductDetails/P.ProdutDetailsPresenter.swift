...
extension P {
    class ProdutDetailsPresenter: BasePresenterVIP {
        ...
        weak var viewController: (ProdutDetailsDisplayLogicProtocol)?
...
extension P.ProdutDetailsPresenter {
...
extension P.ProdutDetailsPresenter: ProdutDetailsPresentationLogicProtocol {
    ...
    func presentScreenInitialState(response: VM.ProdutDetails.ScreenInitialState.Response) {
        ...
        let viewModel = VM.ProdutDetails.ScreenInitialState.ViewModel(title: title,
                                                                                 subTitle: subTitle)
    ...
    func presentSomething(response: VM.ProdutDetails.Something.Response) {
        ...
        let someListA = response.listA
            .map { VM.ProdutDetails.TableItem(enabled: true,
        ...
        let viewModel = VM.ProdutDetails.Something.ViewModel(subTitle: subTitle,
                                                                        someValue: "\(sum)",
