...
extension V {
    class CarTrackUsersView: BaseGenericViewVIP {
        ...
        typealias Section = AnimatableSectionModel<String, VM.CarTrackUsers.TableItem>
...
/*
            ...
            (
                ...
                "<NSLayoutConstraint:0x600001df7c00 H:|-(0)-[UIScrollView:0x7ffb2d021200](LTR)   (active, names: '|':_TtCC8GoodToGo7AppView28CarTrackUsersView:0x7ffb2c508d80 )>",
                "<NSLayoutConstraint:0x600001df7c50 UIScrollView:0x7ffb2d021200.right == _TtCC8GoodToGo7AppView28CarTrackUsersView:0x7ffb2c508d80.right   (active)>",
                "<NSLayoutConstraint:0x600001da8910 '_UITemporaryLayoutWidth' _TtCC8GoodToGo7AppView28CarTrackUsersView:0x7ffb2c508d80.width == 0   (active)>",
...
*/
        ...
        override func prepareLayoutByFinishingPrepareLayout() {
            V.CarTrackUsersTableViewCell.prepare(tableView: tableView)
        ...
        override func setupViewUIRx() {
            let dataSource = RxTableViewSectionedAnimatedDataSource<Section>(
                configureCell: { _, tableView, indexPath, item in
                    ...
                    case .cellType1:
                        let reuseIdentifier = CarTrackUsersTableViewCell.reuseIdentifier
                        if let cell = tableView.dequeueReusableCell(withIdentifier: reuseIdentifier,
                                                                    for: IndexPath(row: row, section: section)) as? CarTrackUsersTableViewCell {
            ...
            tableView.rx.modelSelected(VM.CarTrackUsers.TableItem.self)
        ...
        func setupWith(someStuff viewModel: VM.CarTrackUsers.SomeStuff.ViewModel) {
        ...
        func setupWith(screenInitialState viewModel: VM.CarTrackUsers.ScreenInitialState.ViewModel) {
            subTitle = viewModel.subTitle
            screenLayout = viewModel.screenLayout
        }

        var screenLayout: E.CarTrackUsersView.ScreenLayout = .unknown {
            didSet {
                // show or hide stuff
            }
        }
...
extension V.CarTrackUsersView: UITableViewDelegate {
    ...
    public func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        if let sectionItem = try? rxTableItems.value() {
            ...
            switch item.cellType {
            case .cellType1: return V.CarTrackUsersTableViewCell.cellSize
            case .cellType2: return V.CarTrackUsersTableViewCell.cellSize
            }
        }
        return 0
    }
...
extension V.CarTrackUsersView {
    ...
    var rxModelSelected: ControlEvent<VM.CarTrackUsers.TableItem> {
        tableView.rx.modelSelected(VM.CarTrackUsers.TableItem.self)
    }
}
