...
extension P.CategoriesPickerPresenter {
...
extension P.CategoriesPickerPresenter: CategoriesPickerPresentationLogicProtocol {
    ...
    func presentScreenInitialState(response: VM.CategoriesPicker.ScreenInitialState.Response) {
        ...
        let viewModel = VM.CategoriesPicker.ScreenInitialState.ViewModel(title: title,
                                                                                 subTitle: subTitle,
    ...
    func presentSomething(response: VM.CategoriesPicker.Something.Response) {
        ...
        let someListA = response.listA
            .map { VM.CategoriesPicker.TableItem(enabled: true,
        ...
        let viewModel = VM.CategoriesPicker.Something.ViewModel(subTitle: subTitle,
                                                                        someValue: "\(sum)",
