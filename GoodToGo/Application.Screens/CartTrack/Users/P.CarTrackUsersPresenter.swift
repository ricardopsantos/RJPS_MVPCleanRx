//
//  P.CarTrackUsersPresenter.swift
//  GoodToGo
//
...
extension P {
    class CarTrackUsersPresenter: BasePresenterVIP {
        weak var viewController: (CarTrackUsersDisplayLogicProtocol)?
...
extension P.CarTrackUsersPresenter {
...
extension P.CarTrackUsersPresenter: CarTrackUsersPresentationLogicProtocol {
    ...
    func presentScreenInitialState(response: VM.CarTrackUsers.ScreenInitialState.Response) {
        ...
        let viewModel = VM.CarTrackUsers.ScreenInitialState.ViewModel(title: title,
                                                                                 subTitle: subTitle,
    ...
    func presentSomeStuff(response: VM.CarTrackUsers.SomeStuff.Response) {
        ...
        let someListA = response.listA
            .map { VM.CarTrackUsers.TableItem(enabled: true,
        ...
        let viewModel = VM.CarTrackUsers.SomeStuff.ViewModel(subTitle: subTitle,
                                                                             someValue: "\(sum)",
